...
/**
 * Task 1
 * This is the sorted array of 10 elements
 */
public class Task1 {
    public static void main(String[] args) {
        //Creation of sorted array with 10 elements

        int[] SortedNumbers10 = new int[10];
        for (int i = 0; i < SortedNumbers10.length; i++) {
            SortedNumbers10[i] = i + 1;
        }
        Arrays.sort(SortedNumbers10);
        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                int index = Arrays.binarySearch(SortedNumbers10, element);
                if (index < 0) {
                ...
                SortedNumbers10 = insertElement(SortedNumbers10, element, index);
                ...
                if (index < 0) {
                    ...
                    SortedNumbers10 = deleteElement(SortedNumbers10, index);
            ...
            System.out.println("Array contents: " + Arrays.toString(SortedNumbers10));
        }
    }
