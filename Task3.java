...
/**
 * Task 3
 * This is the sorted array of 1000 elements
 */
public class Task3 {
    public static void main(String[] args) {
        //Creation of sorted array with 1000 elements

        int[] SortedNumbers1000 = new int[1000];
        for (int i = 0; i < SortedNumbers1000.length; i++) {
            SortedNumbers1000[i] = i + 1;
        }
        Arrays.sort(SortedNumbers1000);
        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                int index = Arrays.binarySearch(SortedNumbers1000, element);
                if (index < 0) {
                ...
                SortedNumbers1000 = insertElement(SortedNumbers1000, element, index);
                ...
                if (index < 0) {
                    ...
                    SortedNumbers1000 = deleteElement(SortedNumbers1000, index);
            ...
            System.out.println("Array contents: " + Arrays.toString(SortedNumbers1000));
        }
    }
